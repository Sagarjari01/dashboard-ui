...
const Login = () => {
  return (
    <div className=" flex h-screen">
      <div className="w-2/5 font-Montserrat font-bold bg-black text-white flex items-center justify-center">
        <p className=" text-7xl">Board.</p>
      </div>

      <div className="flex flex-col items-center justify-center w-3/5 bg-[#F5F5F5]">
        <div className=" text-left space-y-5">
          <div>
            <p className="font-Montserrat font-bold text-4xl leading-[44px]">
              Sign in
            </p>
          ...
          <div className="flex flex-row font-Montserrat font-normal ">
            
            
            <div className="flex flex-row items-center justify-center bg-white rounded-[10px] px-4 py-2 cursor-pointer">
              <svg
                width="14"
                height="14"
                viewBox="0 0 14 14"
              ...
              <div className="text-xs leading-[15px] text-[#858585] pl-3">
                Sign in with Google
              </div>
            </div>
            <div className="flex flex-row items-center justify-center bg-white rounded-[10px] px-4 py-2 ml-8 cursor-pointer">
              <svg
                width="12"
                height="14"
                viewBox="0 0 12 14"
          ...
          <div className="bg-white p-6 rounded-[20px] font-Lato font-normal text-base space-y-4">
            <div className=" space-y-1">
              <p>Email address</p>
              <input
                type="email"
                value="johndoe@gmail.com"
                className="bg-[#F5F5F5] rounded-[10px] w-full py-2 px-3"
              />
            </div>
            <div className="space-y-1">
              <p>Password</p>
            ...
            <p className="text-[#346BD4] ">
              <a href="#">Forget password?</a>
            </p>
            <div className="bg-black text-white rounded-[10px] flex font-Montserrat font-bold text-base items-center justify-center py-2 cursor-pointer">
              Sign in
            </div>
          </div>
