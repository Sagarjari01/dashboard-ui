...
const Dashboard = () => {
  ...
  return (
    <div className="p-8 flex h-auto space-x-8  bg-[#DDDDDD] ">
      {/* Left pane */}
      ...
      <div className=" w-full flex flex-col space-y-8 py-4">
        <div className="flex justify-between">
          <div>
            <p className=" font-Montserrat font-bold text-2xl">Dashbaord</p>
          </div>
          <div className="flex flex-row space-x-6 items-center">
            <div>
              <input
                className=" px-3 h-[30px] w-[180px] rounded-[10px] items-center  placeholder:text-sm font-Lato"
                type="text"
                placeholder="Search.."
              />
            </div>
        ...
        <div className="flex flex-row justify-between items-center text-left">
          <div className=" bg-[#DDEFE0] w-64 p-4 rounded-[10px] space-x-1 space-y-1 px-6">
            ...
            <div className="font-Lato font-normal text-sm">Total Revenues</div>
            <div className=" font-Opensans font-bold text-2xl">$2,129,430</div>
          </div>

          <div className=" bg-[#F4ECDD] w-64 p-4 rounded-[10px] space-x-1 space-y-1 px-6">
            <div className="flex justify-end  pl-36">
              <svg
                width="21"
                height="24"
            ...
            <div className="font-Lato font-normal text-sm">
              Total Transactions
            </div>
            <div className=" font-Opensans font-bold text-2xl">1,520</div>
          </div>

          <div className=" bg-[#EFDADA] w-64 p-4 rounded-[10px] space-x-1 space-y-1 px-6">
            <div className="flex justify-end  pl-36">
              <svg
                width="24"
                height="24"
            ...
            <div className="font-Lato font-normal text-sm">Total Likes</div>
            <div className=" font-Opensans font-bold text-2xl">9,721</div>
          </div>

          <div className=" bg-[#DEE0EF] w-64 p-4 rounded-[10px] space-x-1 space-y-1 px-6">
            <div className="flex justify-end  pl-36">
              <svg
                width="37"
                height="24"
            ...
            <div className="font-Lato font-normal text-sm">Total Users</div>
            <div className=" font-Opensans font-bold text-2xl">892</div>
          </div>
        </div>
        <div className="flex flex-col bg-white h-[359px] w-full rounded-[10px] p-6  ">
          <div className="flex flex-row text-center justify-between ">
            <div className="flex flex-col text-left pl-7">
              <div className="font-bold text-lg border-none">Activites</div>
              <select
                className=" font-normal text-xs text-[#858585]"
                name="month"
                id="select-data"
              >
                <option className="" value="May-June 2021">
                  May-June 2021
                </option>
                <option value="May-June 2021">May-June 2022</option>
              </select>
            </div>
          </div>
          <ResponsiveContainer className=" flex-1 py-2" width="100%" height="70%">
            <LineChart
              width={500}
              height={300}
              data={data1}
        ...
        <div className="flex flex-row h-[256px] w-full round space-x-8">
          <div className="  w-1/2 bg-white rounded-[10px] font-Montserrat p-8 leading-[22px] space-y-2">
            <div className="flex flex-row text-center justify-between ">
              <div className="font-bold text-lg border-none">Top products</div>
              <select
                className="font-normal text-xs text-[#858585]"
                name="month"
                id="select-data"
            ...
            <div className="flex flex-row text-center justify-start">
              <div className="flex">
                <PieChart className="flex-1 pl-8" width={170} height={170}>
                  <Pie
                    data={data2}
                    cx="50%"
                    cy="50%"
              ...
              <div className="pl-32">
                <ul className="space-y-3">
                  {data2.map((entry, index) => {
                    ...
                    return (
                      <div>
                        <div className=" font-Montserrat flex flex-row space-x-4 items-center justify-center">
                          <span
                            style={{ backgroundColor: color }}
                            className=" w-3 h-3 rounded-full"
                          ></span>
                          <li className=" font-bold items-center text-sm">
                            {entry.name}
                          </li>
                        </div>
                        <p className="font-Lato font-normal text-xs text-[#858585]">
                          {(entry.value / 100) * 10}%
                        </p>
                      </div>
                    );
          ...
          <div className="w-1/2 bg-white rounded-[10px] font-Montserrat p-8 leading-[22px] space-y-2">
            <div className="flex flex-row text-center justify-between ">
              <div className="font-bold text-lg border-none">
                Today’s schedule
              </div>
              <div className="flex flex-row items-center space-x-1 text-xs cursor-pointer">
                <p>See all</p>
                <span>
                  <svg
                    width="5"
            ...
            <div className="pt-2 w-full h-full space-y-4 ">
              <div className="flex flex-col text-left font-Lato font-normal justify-center text-sm border-l-[5px] border-[#9BDD7C] pl-2 h-[66px] leading-4">
              ...
              <div className=" flex flex-col text-left font-Lato font-normal justify-center text-sm border-l-[5px] border-[#6972C3] pl-2 h-[66px] leading-4">
                <p className="text-[#666666]">
